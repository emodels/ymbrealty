<div class="row <?php echo $index%2 ? 'listview_row_main' : 'listview_row_alternative' ?>">
    <div class="column" style="width: 210px">
        ...
        <div><a href="#"><img src="<?php echo Yii::app()->baseUrl; ?>/property_images/<?php echo $data->image_main; ?>" style="width: 200px; border-radius: 10px; border: solid 1px gray" class="opacity_effect"/></a></div>
    </div>
    <div class="column" style="width: 900px; padding-top: 5px">
        <div style="font-size: 22px; text-align: center; color: black; padding-bottom: 20px"><a href="#"><b><?php echo $data->title; ?></b></a></div>
        <div style="padding: 10px 0 10px 0; font-size: 18px; border-bottom: dotted 1px gray; text-align: left">
            ...
            <div class="column" style="width: 200px">$ <?php echo $data->price; ?> USD</div>
